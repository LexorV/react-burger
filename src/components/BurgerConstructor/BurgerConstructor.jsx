import { Typography, Box, CurrencyIcon, ConstructorElement, Button} from '@ya.praktikum/react-developer-burger-ui-components';
...
<div className="constructor__lock-elements mt-4">
 ...
 <div className="constructor__price-container mt-10">
